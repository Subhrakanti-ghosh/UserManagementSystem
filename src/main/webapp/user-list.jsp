    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
     ...
     Management System </a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li><a href="<%=request.getContextPath()%>/user/logout" class="nav-link">Logout</a></li>
                    </ul>
                </nav>
            </header>
            <br>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="user" items="${listUser}">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<%=request.getContextPath()%>/user/edit?id=<c:out value='${user.id}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="<%=request.getContextPath()%>/user/delete?id=<c:out value='${user.id}' />">Delete</a></td>
                                </tr>
                            </c:forEach>
                            <!-- } -->
                        </tbody>
