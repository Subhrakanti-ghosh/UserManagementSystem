...
//"/user/new","/user/insert","/user/edit","/user/update","/user/delete","/user/list"
@WebServlet({"/user","/user/new","/user/insert","/user/edit","/user/update","/user/delete","/user/list","/user/logout"})
